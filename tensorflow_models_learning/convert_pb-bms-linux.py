...
def freeze_graph_test(pb_path, image_path):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            #output_tensor_name = sess.graph.get_tensor_by_name("MobilenetV1/prediction_fn/Predictions")
            #output_tensor_name = sess.graph.get_tensor_by_name("MobilenetV1/Predictions/Reshape_1")  
            # 读取测试图片
...
if __name__ == '__main__':
    ...
    input_checkpoint='/media/jcq/Doc/DL_data/distracted_driver_detection/dataset/models/model.ckpt-20000'
    # 输出pb模型的路径
    out_pb_path="/media/jcq/Doc/DL_data/distracted_driver_detection/dataset/models/pb/frozen_model-prediction-1.pb"
    # 调用freeze_graph将ckpt转为pb
    freeze_graph(input_checkpoint,out_pb_path)

    # 测试pb模型
    image_path = '/media/jcq/Doc/DL_data/distracted_driver_detection/dataset/test_images/img_1.jpg'
