...
if __name__=='__main__' and sys.argv[1]=='train':
    ...
    for i in range(0,NUM_CLASSES):
        dir = './reference/train_images/training-set/chinese-characters/%s/' % i           # 这里可以改成你自己的图片目录，i为分类标签
    ...
    val_count = 0
    for i in range(0,NUM_CLASSES):
        dir = './reference/train_images/validation-set/chinese-characters/%s/' % i           # 这里可以改成你自己的图片目录，i为分类标签
        for rt, dirs, files in os.walk(dir):
            for filename in files:
                val_count += 1
