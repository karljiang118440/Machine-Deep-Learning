...
- Run the following script to generate TFRecords.
	...
	修改为：
	/home/jcq/.conda/envs/tensorflow_gpu/bin/python dataset/convert_tfrecords.py \
	--dataset_directory='/media/jcq/Doc/DL_data/VOC' \
	--output_directory='/media/jcq/Doc/DL_data/VOC/dataset/tfrecords'
