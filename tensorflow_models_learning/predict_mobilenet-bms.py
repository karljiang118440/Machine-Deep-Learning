...
#karl-1-20191127:修改原先 inceptionv3为 mobilenet_v1
...
if __name__ == '__main__':
    ...
    class_nums=5
    image_dir='E:/DL_data/distracted_driver_detection/dataset/test_images'
    labels_filename='E:/DL_data/distracted_driver_detection/dataset/label.txt'

   # karl-3-20191127:模型改为20000  
    models_path='E:/DL_data/distracted_driver_detection/dataset/models/model.ckpt-50000'

    batch_size = 1  #

   # karl-2-20191127:修改其尺寸大小
